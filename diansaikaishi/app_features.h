...
#define BALANCE_POSITION_MAX_STEP_RATE_HZ          (300U)
#define BALANCE_POSITION_STEP_RATE_KP              (2U)
...
#define BALANCE_BALL_PD_KP_COUNTS_PER_MM_X100         (225)
#define BALANCE_BALL_PD_KD_COUNTS_PER_MM_S_X100       (135)
