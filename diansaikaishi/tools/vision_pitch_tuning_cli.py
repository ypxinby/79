#!/usr/bin/env python3
"""PC command-line client for the MSPM0 Vision Pitch Tuning console."""
...
def run_self_test() -> None:
    vectors = {
        "SET DB 8": b"$VPT SET DB 8\r\n",
        "SET KP 0.060": b"$VPT SET KP 0.060\r\n",
        "SET MAXSPD 6": b"$VPT SET MAXSPD 6\r\n",
        "GET PARAM": b"$VPT GET PARAM\r\n",
        "DEFAULT": b"$VPT DEFAULT\r\n",
        "$VPT SET TIMEOUT 300": b"$VPT SET TIMEOUT 300\r\n",
        "$vpt get param": b"$VPT get param\r\n",
    }
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Vision Pitch Tuning serial command client"
    )
    parser.add_argument("command", nargs="*", help='for example: "SET KP 0.060"')
