...
typedef struct {
    ...
    float heading_gyro_feedback_dps;
    float heading_update_dt_s;
    bool heading_dt_valid;
    ...
    int16_t heading_left_command;
    int16_t heading_right_command;
    int16_t heading_correction;
    uint32_t heading_settle_elapsed_ms;
    uint32_t heading_action_elapsed_ms;
    uint32_t heading_action_timeout_ms;
