...
build-977875341: ../empty.syscfg
	...
	"D:/TI/CCS/ccs/utils/sysconfig_1.26.0/sysconfig_cli.bat" -s "C:/TI/mspm0_sdk_2_05_01_00/.metadata/product.json" --script "D:/selfthings/github_project/work_ti/79/diansaikaishi/empty.syscfg" -o "." --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '
